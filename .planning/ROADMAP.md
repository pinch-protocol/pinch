...
- [ ] **Phase 8: Relay Hardening and Dead Code Removal** - Remove TrackFlushKey/PopFlushKey dead code, lock down InsecureSkipVerify for production
...
| 8. Relay Hardening and Dead Code Removal | 0/0 | Not Started | - |
